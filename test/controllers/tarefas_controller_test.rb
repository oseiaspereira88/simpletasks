...
class TarefasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarefa" do
    assert_difference('Tarefa.count') do
      post tarefas_url, params: { tarefa: { descricao: @tarefa.descricao, entrega_date: @tarefa.entrega_date, update_date: @tarefa.update_date } }
    end
  ...
  test "should update tarefa" do
    patch tarefa_url(@tarefa), params: { tarefa: { descricao: @tarefa.descricao, entrega_date: @tarefa.entrega_date, update_date: @tarefa.update_date } }
